...
//	public bool NearMode = false;
	...
	public ushort GetDepthForPixel(int x, int y)
	{
        ...
        //if (KinectGestures.run == true) CalibrationText.GetComponent<GUIText>().text = "Run Detected";
...
//					}
	...
	void UpdateColorMap()
	{
        ...
        usersClrTex.Apply();
        //for(int i=300;i<340;i++) for(int j=220;j<260;j++) Debug.Log(colorImage.GetValue(i,j));
        //Debug.Log(colorImage.GetValue(320, 240));
    }
